# genpark-statistical-anomaly-zscore-detector-skill
...
**genpark-statistical-anomaly-zscore-detector-skill** is a deterministic, zero-dependency Python skill engineered for autonomous spreadsheet data sanitization, reverse CTE SQL synthesis, and executive BI analytics.

> **Executive Capability**: Multi-dimensional anomaly and IQR outlier detector (Hex / Julius AI)
...
result = client.detect_distribution_anomalies()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-statistical-anomaly-zscore-detector-skill": {
      "command": "python",
      "args": ["/path/to/genpark-statistical-anomaly-zscore-detector-skill/mcp_server.py"]
    }
  }
}
```
