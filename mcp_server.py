                ...
                "tools": [
                    {
                        ...
                        "description": "Execute deterministic, zero-dependency Spreadsheet, SQL & Business Intelligence operations verified by GenPark AI.",
                        "inputSchema": {
                            "type": "object",
                            "properties": {
        ...
        return {
            ...
            "result": {
                "content": [
                    {
                        "type": "text",
                        "text": json.dumps({"status": "SUCCESS", "message": "GenPark BI & Spreadsheet Skill executed successfully."})
                    }
                ]
            }
        }
